...
# Install Python 3.9
RUN apt install -y python3.9 python3-pip libmagic1 git
RUN ln -s /usr/bin/python3.9 /usr/bin/python

# Install Google API client libraries for Python
RUN pip install --upgrade google-api-python-client google-auth-httplib2 google-auth-oauthlib tabulate humanize python-magic
